    ...
    <div class="col-md-3">
        <div class="card">
            <div class="card-body">
                ...
                <p class="card-text">￥<?php echo number_format($todayOrderTotalMoney / 100, 2); ?> RMB</p>
            </div>
        </div>
    </div>
    <div class="col-md-3">
        <div class="card">
            <div class="card-body">
                ...
                <p class="card-text">￥<?php echo number_format($yesterdayOrderTotalMoney / 100, 2) ?> RMB</p>
            </div>
        </div>
    </div>
    <div class="col-md-12">
