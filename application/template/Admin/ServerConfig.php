...
<script>
    $(function(){$("[data-name]").each(function(a,b){var c=$(b),d=c.attr("data-name");$.getJSON("/admin/api/Config",{keyName:d},function(a){1===a["status"]&&(("defaultMaxPayMoney"===d||"defaultMoneyRate"===d)&&(a["data"]=a["data"]/100),c.val(a["data"]))})}),$("#setAdmin").click(function(){var a=$("#username").val(),b=$("#password").val();return 0===a.length?(swal({title:"",text:"管理员用户名不能为空",showConfirmButton:!1,timer:1500,type:"error"}),!0):0===b.length?(swal({title:"",text:"管理员密码不能为空",showConfirmButton:!1,timer:1500,type:"error"}),!0):($.post("/admin/api/SetAdmin",{username:a,password:b},function(a){0===a["status"]&&swal({title:"",text:a["msg"],showConfirmButton:!1,timer:1500,type:"error"}),swal({title:"",text:a["msg"],showConfirmButton:!1,timer:1500,type:"success"})},"json"),void 0)}),$("button[data-save]").click(function(){var a=$(this);a.parent().find("[data-name]").each(function(a,b){var c=$(b),d=c.attr("data-name"),e=c.val();("0"===e||"1"===e)&&(e="0"!==e),$.post("/admin/api/Config",{keyName:d,data:e}),swal({title:"",text:"保存数据成功",showConfirmButton:!1,timer:1500,type:"success"})})})});
</script>